...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-[#0F1117] shadow-xs hover:bg-primary/90 shadow-primary/10",
        destructive:
          "bg-destructive text-white shadow-xs hover:bg-destructive/90",
        outline:
          "border border-[#2a2c37] bg-transparent text-white shadow-xs hover:bg-[#1a1c25] hover:text-white",
        secondary:
          "bg-[#1a1c25] text-white shadow-xs hover:bg-[#20222d]",
        ghost:
          "text-white hover:bg-[#1a1c25]",
